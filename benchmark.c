...
#define Z_VALUE 1.96 // corresponds to 95% confidence interval (1.64...90%, 1.96...95%, 2.57...99%)
...
{
    /* given an array of runtimes, compute:
        - average
        - standard deviation
        - median
        - minimum
...
int main(int argc, char *argv[])
{
    ...
    int r, t;   // for inner most loop running to aquire statistics
    ...
    for (int i = 0; i < 10; ++i)
    {
        ...
        for (int blockSize = c / 4 + 1; blockSize < c; blockSize += c / 4 + 1)
        {
            ...
            if (rank == 0)
            {
                statistics(runtime1, c, blockSize, size, repeat, median_idx, '1');   // '1' for Exercise 1
                statistics(runtime2, c, blockSize, size, repeat, median_idx, '2');   // '2' for Exercise 2
                statistics(runtime3, c, blockSize, size, repeat, median_idx, '3');   // '3' for Exercise 3
                statistics(runtime4, c, blockSize, size, repeat, median_idx, '4');   // '4' for Exercise 4
                statistics(runtime5, c, blockSize, size, repeat, median_idx, '5');   // '5' for Exercise 5
